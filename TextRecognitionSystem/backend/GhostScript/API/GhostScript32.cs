...
namespace GhostscriptSharp.API
{
    internal class GhostScript32
    {
        ...
        [DllImport(@"Ghostscript\dlls\gsdll32.dll", EntryPoint = "gsapi_new_instance")]
        private static extern int CreateAPIInstance(out IntPtr pinstance, IntPtr caller_handle);

        [DllImport(@"Ghostscript\dlls\gsdll32.dll", EntryPoint = "gsapi_init_with_args")]
        private static extern int InitAPI(IntPtr instance, int argc, string[] argv);

        [DllImport(@"Ghostscript\dlls\gsdll32.dll", EntryPoint = "gsapi_exit")]
        private static extern int ExitAPI(IntPtr instance);

        [DllImport(@"Ghostscript\dlls\gsdll32.dll", EntryPoint = "gsapi_delete_instance")]
